 class User {
    public username: string = "kavya123";  // Anyone can see this
    private password: string = "pass123";  // Locked inside this class
    protected pinCode: number = 4455;      // Only for this class and children

    // This function lets a user enter a password safely
    public checkPassword(input: string): void {
